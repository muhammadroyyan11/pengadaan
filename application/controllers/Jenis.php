...
class Jenis extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('templates/template', 'jenis/data', $data);
    }
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = "Jenis";
            $this->template->load('templates/template', 'jenis/add', $data);
        } else {
    ...
    public function edit($getId)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->template->load('templates/template', 'jenis/edit', $data);
        } else {
            $input = $this->input->post(null, true);
