...
class User extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('templates/template', 'user/data', $data);
    }
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->template->load('templates/template', 'user/add', $data);
        } else {
    ...
    public function edit($getId)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->template->load('templates/template', 'user/edit', $data);
        } else {
            $input = $this->input->post(null, true);
            $input_data = [
                'nama'          => $input['nama'],
