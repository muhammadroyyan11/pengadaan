...
class Barang extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('templates/template', 'barang/data', $data);
    }
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->template->load('templates/template', 'barang/add', $data);
        } else {
    ...
    public function edit($getId)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->template->load('templates/template', 'barang/edit', $data);
        } else {
            $input = $this->input->post(null, true);
