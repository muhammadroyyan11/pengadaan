...
class Supplier extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('templates/template', 'supplier/supplier_data', $data);
    }
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = "Supplier";
            $this->template->load('templates/template', 'supplier/supplier_add', $data);
        } else {
    ...
    public function edit($getId)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->template->load('templates/template', 'supplier/supplier_edit', $data);
        } else {
            $input = $this->input->post(null, true);
